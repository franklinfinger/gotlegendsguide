function avatarHTML(c, size) {
  ...
  return '<img src="data:image/jpeg;base64,' + portrait + '" alt="" width="' + s + '" height="' + s + '" style="width:' + s + 'px;height:' + s + 'px;border-radius:9999px;object-fit:cover;flex-shrink:0;border:2px solid #c9a22766;background:#1a1a20" onerror="this.outerHTML=decodeURIComponent(this.dataset.fb)" data-fb="' + encodeURIComponent(initials) + '" />';
}
